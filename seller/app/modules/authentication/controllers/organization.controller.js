...
class OrganizationController {
    ...
    async getOrgDetailsForOndc(req, res, next) {
        try {
            const params = req.params;
            const organizations =
    ...
    async ondcGet(req, res, next) {
        try {
            const params = req.params;
            const organizations = await organizationService.ondcGet(
                params.organizationId
            );
            return res.send(organizations);
        } catch (error) {
    ...
    async setStoreDetails(req, res, next) {
        try {
            const params = req.params;
            const data = req.body;
            const organizations = await organizationService.setStoreDetails(
                params.id,
                data
            );
            return res.send(organizations);
    ...
    async update(req, res, next) {
        try {
            const params = req.params;
            const data = req.body;
            const organizations = await organizationService.update(
                params.id,
                data
            );
            return res.send(organizations);
    ...
    async getStoreDetails(req, res, next) {
        try {
            const params = req.params;
            const data = req.body;
            const organizations = await organizationService.getStoreDetails(
                params.organizationId,
                data
            );
            return res.send(organizations);
